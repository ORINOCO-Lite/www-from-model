...
params:
  ...
  description: "This dataset consists of empirical 3T fMRI data recorded at three spatial\n\
    ...
    \ in visual cortex \u2014 in order to test hypotheses on the strength and\nspatial\
    \ scale of orientation discriminating signals. This is an extension of\nthe studyforrest\
    \ project. All seven participants previously volunteered for the\naudio-only and\
    \ the audio-visual Forrest Gump study.\nFive of the seven participants also participated\
    \ in a matching study using\nidentical protocols, but 7T data acquisition (with\
    \ the same the three spatial\nresolutions used here, plus a 0.8 mm acquisition).\
    \ The dataset is compliant\nwith the BIDS data description standard (http://bids.neuroimaging.io).\
